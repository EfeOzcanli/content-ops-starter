...
sections:
  - type: GenericSection
    title:
      text: 'Meet the Legend: The Cluckz Signature Sandwich'
      color: text-dark
      type: TitleBlock
    subtitle: Every Bite is a Craft
    text: >
      Double-stacked crispy tenders, toasted brioche, and our house-made pink
      sauce.
  ...
  - type: FeaturedItemsSection
    title:
      text: Have you tried our Sandwiches?
      color: text-dark
      styles:
        self:
          textAlign: center
